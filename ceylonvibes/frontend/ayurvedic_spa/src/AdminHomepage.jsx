import AyurvedicSpaMenuuu from './assets/ayurvedic-spa-menu.png'
import ClassicalSpaRitualsss from './assets/classical-spa-rituals.png'
import HomePagee from './assets/homepage.png'
...
return(
   <div className="spa-menu p-12 max-w-7.5xl mx-auto text-center bg-yellow-100"> 
    ...
    <img src={HomePagee} alt="HomePage" className="border border-black w-full h-64 object-cover mb-10"></img>
    </div>
    ...
    <div className="ayurvedic-spa bg-white p-6 rounded-lg shadow-md mb-8"> 
           <img src={AyurvedicSpaMenuuu} alt="Ayurvedic-spa-menu" className="w-full h-64 object-cover mb-4"></img>
          ...
          <button className="bg-green-400 hover:bg-green-900 text-white font-bold py-2 px-4 rounded transition duration-200">
            View for More</button>
            <button className="bg-green-400 hover:bg-green-900 text-white font-bold py-2 px-4 rounded transition duration-200">
            Edit Services</button></div>
        </div>
        </div>

        <div className="flex justify-center spa-categories grid grid-cols-1 gap-8">
        <div className="classical-spa-rituals bg-white p-6 rounded-lg shadow-md mb-8">
        <img src={ClassicalSpaRitualsss} alt="classical-spa-rituals" className="w-full h-64 object-cover mb-4"></img>  
